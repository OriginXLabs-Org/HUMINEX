...
const tierDetails: Record<ClientTier, { 
  ...
  basic: {
    ...
    description: "Essential features for early teams",
  ...
  standard: {
    ...
    features: ["Everything in Startup", "Meetings", "Team Directory", "Feedback"]
  },
  advanced: {
    name: "Enterprise",
    color: "bg-purple-500/10 text-purple-600 border-purple-500/20",
    description: "Advanced features for growing companies",
    features: ["Everything in Growth", "AI Dashboard", "Resources Library"]
  },
  enterprise: {
    name: "Enterprise Plus",
    color: "bg-amber-500/10 text-amber-600 border-amber-500/20",
    description: "Full access for enterprise clients",
    features: ["Everything in Enterprise", "MSP Monitoring", "Priority Support", "Custom Integrations"]
  }
};
