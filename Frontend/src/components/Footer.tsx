import { Mail, FileText, Shield, HeadphonesIcon, ArrowUpRight } from "lucide-react";
import { Link } from "react-router-dom";
import huminexLogo from "@/assets/huminex-logo.svg";
...
const contactEmails = [
  { label: "General", email: "hello@gethuminex.com", icon: Mail },
  { label: "Support", email: "support@gethuminex.com", icon: HeadphonesIcon },
  { label: "Legal", email: "legal@gethuminex.com", icon: FileText },
  { label: "HR", email: "hr@gethuminex.com", icon: Shield },
];
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="py-16 lg:py-20 grid sm:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-8 max-w-sm leading-relaxed text-sm">
              Consulting & Digital Transformation wing of OriginX Labs Pvt. Ltd. 
        ...
        <div className="py-5 border-t border-border/40 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2 text-xs">
            <span className="text-foreground font-medium">© {new Date().getFullYear()} OriginX Labs Pvt. Ltd.</span>
            <span className="text-muted-foreground">•</span>
            <a href="https://www.gethuminex.com" className="text-primary hover:text-primary/80 transition-colors font-semibold">
              www.gethuminex.com
            </a>
          </div>
