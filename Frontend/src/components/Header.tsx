    ...
    <header className={`fixed top-0 left-0 right-0 z-[100] bg-card/95 backdrop-blur-xl border-b border-border/40 transition-all duration-300 ${isScrolled ? 'shadow-lg' : ''}`}>
      <nav className="container mx-auto px-4 lg:px-8" aria-label="Main navigation">
        <div className={`flex items-center justify-between transition-all duration-300 ${isScrolled ? 'h-14' : 'h-16 lg:h-18'}`}>
          {/* Logo */}
          <Link to="/" className="flex items-center group" aria-label="HUMINEX Home">
                    ...
                    <div className="p-2 space-y-1">
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <span className="text-xs text-muted-foreground">For employees and team members</span>
                        </div>
                      </Link>
                      <Link
                        to="/tenant/login"
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <span className="text-sm font-medium block">Employer Portal</span>
                          <span className="text-xs text-muted-foreground">For founders, HR, finance and admins</span>
                        </div>
                      </Link>
                    </div>
                  </div>
