...
const plans = [
  {
    ...
    features: [
      { label: "5-50 employees", included: true },
      { label: "Employee and org management", included: true },
  ...
  },
  {
    ...
    features: [
      { label: "50-300 employees", included: true },
      { label: "All Startup features", included: true },
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="text-center mb-4">
                ...
                <span className="text-sm text-[#6B7280]">/employee/{plan.period}</span>
              </div>
