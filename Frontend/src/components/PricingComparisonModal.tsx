...
const competitorPricing: CompetitorPricing[] = [
  ...
  {
    name: "Keka",
    monthlyPerEmployee: 420,
    setupFee: 15000,
    annualDiscount: 8,
    hiddenCosts: ["Advanced workflows", "Custom APIs", "Migration support"],
  },
  {
    name: "Zoho People",
    monthlyPerEmployee: 350,
    setupFee: 0,
    annualDiscount: 15,
...
const huminexPricing = {
  ...
  includedFeatures: [
    ...
    "Enterprise-ready RBAC and audit",
    "OpenHuman bundled in Enterprise",
    "24/7 Priority Support",
    "No setup fee",
    "Transparent pricing model",
    "Azure-grade security posture",
  ],
};
...
export const PricingComparisonModal = ({ trigger }: PricingComparisonModalProps) => {
  ...
  const calculateAnnualCost = (pricing: CompetitorPricing | typeof huminexPricing) => {
  ...
  const huminexCost = calculateAnnualCost(huminexPricing);
          ...
          <DialogHeader>
            <div className="flex items-center gap-2 mb-2">
              ...
              <DialogTitle className="text-2xl font-bold text-white">
                HUMINEX Savings Calculator
              </DialogTitle>
            </div>
            <p className="text-white/80 text-sm">
              See how much your organization can save by switching to HUMINEX
            </p>
          </DialogHeader>
        ...
        <div className="p-6">
          ...
          >
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-xl font-bold text-foreground">HUMINEX Premium</h3>
              ...
              <div className="text-right">
                <div className="text-3xl font-bold text-primary">
                  ₹{huminexCost.annual.toLocaleString()}
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-6">
              {huminexPricing.includedFeatures.map((feature, index) => (
          ...
          <div className="grid gap-4">
            {competitorPricing.map((competitor, index) => {
              ...
              const savings = competitorCost.totalFirstYear - huminexCost.totalFirstYear;
          ...
          <div className="mt-8 p-6 rounded-2xl bg-gradient-to-r from-primary/10 via-primary/5 to-cyan-500/10 border border-primary/20 text-center">
            <h4 className="text-xl font-bold mb-2 text-foreground">
              Ready to Save with HUMINEX?
            </h4>
            <p className="text-muted-foreground text-sm mb-4 max-w-md mx-auto">
              Switch to HUMINEX and unlock enterprise features at a fraction of the cost. 
