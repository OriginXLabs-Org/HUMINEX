...
const faqs = [
  ...
  },
  {
    ...
    answer: "We'll notify you when you're approaching your limit. You can upgrade to the next tier or move to an enterprise contract. We never block your operations mid-payroll."
  },
  {
  ...
  },
  {
    ...
    answer: "All plans include email support. Growth and Enterprise tiers get priority support with faster response times and dedicated success guidance."
  }
];
