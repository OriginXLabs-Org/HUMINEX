...
const activeSessions = [
  { id: 1, user: 'admin@gethuminex.com', role: 'Super Admin', ip: '103.45.XX.XX', location: 'Mumbai, India', lastActive: '2 mins ago', device: 'Chrome / Windows' },
  { id: 2, user: 'rahul@gethuminex.com', role: 'Admin', ip: '45.67.XX.XX', location: 'Bangalore, India', lastActive: '15 mins ago', device: 'Firefox / macOS' },
  { id: 3, user: 'priya@gethuminex.com', role: 'Support', ip: '78.90.XX.XX', location: 'Delhi, India', lastActive: '1 hour ago', device: 'Safari / iOS' },
];
