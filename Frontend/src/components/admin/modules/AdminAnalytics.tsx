...
const featureAdoptionData = [
  ...
  { name: 'Huminex Automations', adoption: 32, color: '#14B8A6' },
];
...
const planDistributionData = [
  { name: 'Startup', value: 35, color: '#94A3B8' },
  { name: 'Growth', value: 42, color: '#8B5CF6' },
  { name: 'Enterprise', value: 18, color: '#06B6D4' },
  { name: 'Enterprise Plus', value: 5, color: '#10B981' },
];
