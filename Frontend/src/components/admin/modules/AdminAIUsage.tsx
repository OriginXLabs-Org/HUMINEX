...
const tenantUsageData = [
  ...
  { tenant: "StartupIO", tokens: 95000, cost: 2.30, plan: "Growth", usage: 85 },
  { tenant: "Enterprise Solutions", tokens: 145000, cost: 3.50, plan: "Enterprise", usage: 58 },
  { tenant: "SmallBiz Ltd", tokens: 45000, cost: 1.10, plan: "Startup", usage: 90 },
  { tenant: "AgriTech Farms", tokens: 72000, cost: 1.75, plan: "Growth", usage: 65 }
];
