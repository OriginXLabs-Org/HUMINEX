...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { name: "OpenHuman Dashboard", href: "/admin/ai", icon: Brain },
          ...
          <div className="p-4 border-b border-border">
            <Link to="/admin" className={cn("flex items-center gap-3", collapsed && "justify-center")}>
              <div className="relative">
                ...
                <img src={huminexLogo} alt="HUMINEX" className="relative h-9 w-9" />
              </div>
              {!collapsed && (
                <div>
                  <span className="text-foreground font-heading font-bold text-sm">HUMINEX</span>
                  <span className="block text-primary font-heading font-semibold text-xs">HUMINEX Admin</span>
                </div>
              )}
            </Link>
          </div>
