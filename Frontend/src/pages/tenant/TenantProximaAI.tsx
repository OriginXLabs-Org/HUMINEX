...
const suggestedPrompts = [
  "Start a dynamic interview for Senior Frontend Engineer",
  "Generate role-based follow-up questions from candidate answer",
  "Enable fixed questions for this round",
  "Show real-time interview score out of 10",
  "Prepare HR + Hiring Manager instant feedback card",
];

const TenantProximaAI: React.FC = () => {
  const [query, setQuery] = useState("");
  const [messages, setMessages] = useState<{ role: string; content: string }[]>([
    { role: "assistant", content: "Hello! I am Proxima AI, HUMINEX Agentic Automation for your business, company, and employee insights. I can orchestrate OpenHuman interview workflows, score candidates from 0-10, and generate instant decision support for HR and Hiring Managers." }
  ]);
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      setMessages(prev => [...prev, { 
        role: "assistant", 
        content: `Proxima AI analysis for "${query}":\n\n• OpenHuman interview mode: dynamic (context-aware, no fixed script)\n• Agentic panel: Male Agent + Female Agent active\n• Candidate speaking confidence: 7.8/10\n• Technical depth: 8.2/10\n• Communication clarity: 7.4/10\n• Final blended score: 7.8/10\n\nI can also switch to fixed-question mode if admin policy requires mandatory questions. Video and transcript are captured for replay and audit.`
      }]);
    }, 1000);
    setQuery("");
  };
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[#6B7280]">HUMINEX Agentic Automation for your Business and company and employees insights</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Button variant="outline" className="gap-2" asChild>
            <Link to="/tenant/openhuman-studio">OpenHuman (Interview Studio)</Link>
          </Button>
          <Button variant="outline" className="gap-2">
            <Download className="w-4 h-4" />
            Export Interview Analysis
          </Button>
        </div>
      </div>
        ...
        <Card className="border-none shadow-sm lg:col-span-2">
          <CardHeader className="border-b">
            <CardTitle className="text-lg flex items-center gap-2">
              ...
              Proxima AI Intelligence Console
            </CardTitle>
          </CardHeader>
          <CardContent className="p-0">
                  ...
                  <div className={`max-w-[80%] p-3 rounded-lg ${
                    ...
                    {msg.role === 'assistant' && (
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-xs font-semibold text-[#8B5CF6]">Proxima AI</span>
                      </div>
                    )}
            ...
            <div className="p-4">
              <div className="flex items-center gap-2">
                <Input
                  placeholder="Ask Proxima AI anything about interview flow, scoring, and workforce insights..."
                  value={query}
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6B7280]">Active Interview Insights</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6B7280]">Interview Quality Accuracy</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#6B7280]">Candidates Need Review</p>
                </div>
              </div>
            </CardContent>
          </Card>
      ...
      <Card className="border-none shadow-sm">
        <CardHeader>
          <CardTitle className="text-lg">AI-Generated Interview Insights</CardTitle>
        </CardHeader>
        <CardContent>
