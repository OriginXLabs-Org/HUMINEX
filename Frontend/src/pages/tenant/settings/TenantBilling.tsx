...
const plans = [
  { id: "startup", name: "Startup", price: "₹199", period: "/employee/month", description: "For early teams getting started", features: ["5-50 employees", "Payroll processing", "Payslips and salary reports", "Leave and attendance", "Email support"], current: false },
  { id: "growth", name: "Growth", price: "₹349", period: "/employee/month", description: "For scaling organizations", features: ["50-300 employees", "Advanced payroll rules", "Approval workflows", "Audit logs", "API access", "Priority support"], current: true, popular: true },
  { id: "enterprise", name: "Enterprise", price: "₹499+", period: "/employee/month", description: "For large and regulated organizations", features: ["300+ employees", "Enterprise SSO", "Custom workflows and policies", "Dedicated onboarding", "Compliance customization", "OpenHuman bundled"], current: false }
];

const invoices = [
  { id: "INV-2024-001", date: "Jan 15, 2024", amount: "₹23,383", status: "paid" },
  { id: "INV-2023-012", date: "Dec 15, 2023", amount: "₹23,383", status: "paid" },
  { id: "INV-2023-011", date: "Nov 15, 2023", amount: "₹23,383", status: "paid" },
  { id: "INV-2023-010", date: "Oct 15, 2023", amount: "₹23,383", status: "paid" }
];
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm mt-1">Next billing date: February 15, 2024 • ₹349/employee/month (67 active employees)</p>
            </div>
          </div>
          ...
          {plans.map((plan) => (
            <div key={plan.id} className={`p-6 relative ${plan.current ? "bg-[#005EEB]/[0.02]" : ""}`}>
              ...
              {plan.current ? (
                ...
                <Button onClick={() => handleUpgrade(plan.id)} className={`w-full ${plan.id === "enterprise" ? "bg-[#005EEB] hover:bg-[#0047B3]" : "bg-[#F7F9FC] text-[#0F1E3A] hover:bg-[#E5E7EB]"}`}>
                  {plan.id === "startup" ? "Downgrade" : "Upgrade"}
                </Button>
              )}
            </div>
          ))}
