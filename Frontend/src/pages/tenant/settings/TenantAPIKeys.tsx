...
const webhooks = [
  { id: "1", url: "https://api.yourcompany.com/webhooks/huminex", events: ["employee.created", "payroll.processed"], status: "active", lastTriggered: "1 hour ago" },
  { id: "2", url: "https://slack.com/webhooks/huminex-notifications", events: ["attendance.marked", "leave.approved"], status: "active", lastTriggered: "30 mins ago" }
];
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>Generate a new API key for accessing HUMINEX programmatically.</DialogDescription>
            </DialogHeader>
      ...
      <div className="bg-gradient-to-r from-[#005EEB] to-[#00C2FF] rounded-xl p-6 text-white">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-white/80 text-sm">Learn how to integrate HUMINEX with your applications</p>
          </div>
