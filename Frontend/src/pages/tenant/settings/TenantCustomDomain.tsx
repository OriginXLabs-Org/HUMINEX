...
const dnsRecords = [
  ...
  { type: "TXT", name: "_atlas-verify", value: "huminex-verify=abc123xyz789", ttl: "3600" }
];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#6B7280] mt-1">
            Connect your own domain to your HUMINEX workspace
          </p>
        </div>
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Enter the domain you want to connect to your HUMINEX workspace.
              </DialogDescription>
            </DialogHeader>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-[#6B7280] mb-4">
              HUMINEX automatically provisions and renews SSL certificates for all your domains using Let's Encrypt.
            </p>
