...
const supportChannels = [
  { icon: Mail, label: "General Support", value: "support@gethuminex.com", type: "email" },
  { icon: Building2, label: "Enterprise Support", value: "enterprise@gethuminex.com", type: "email" },
...
const developerResources = [
  { label: "API Documentation", url: "api.gethuminex.com/docs", icon: Code },
  { label: "Webhooks Guide", url: "api.gethuminex.com/webhooks", icon: Zap },
  { label: "Status Page", url: "status.gethuminex.com", icon: Shield }
];
...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | OriginX Labs HUMINEX - Get in Touch</title>
        <meta name="description" content="Contact OriginX Labs HUMINEX for enterprise workforce solutions. Reach out for demos, support, or partnership inquiries." />
        <link rel="canonical" href="https://www.gethuminex.com/contact" />
      </Helmet>
