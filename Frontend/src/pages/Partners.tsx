...
const internalServices = [
  {
    ...
    description: "Full-service payroll, compliance, and HR operations managed by OriginX Labs team",
...
const Partners = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await platform.from("inquiries").insert({
  ...
  return (
    <>
      <Helmet>
        <title>Partner with HUMINEX | OriginX Labs Technology Partner Program</title>
        <meta 
          name="description" 
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-20">
          ...
          {/* Internal Services - OriginX Labs Managed */}
          <section className="py-16 bg-muted/30">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                <Badge className="mb-4 bg-accent/10 text-accent border-accent/20">
                  <Shield className="w-3 h-3 mr-1" />
                  Managed by OriginX Labs
                </Badge>
