...
const industriesData: Record<string, IndustryData> = {
  "retail": {
    ...
    testimonial: {
      quote: "HUMINEX transformed how we manage 2,000+ store employees across 150 locations. Scheduling that used to take days now happens in hours.",
      author: "Priya Sharma",
      role: "Head of HR",
  ...
  "foodtech": {
    ...
    testimonial: {
      quote: "Managing 500+ delivery partners and restaurant staff used to be chaos. HUMINEX brought order and visibility we never had before.",
      author: "Rahul Mehta",
  ...
  "healthcare": {
    ...
    testimonial: {
      quote: "In healthcare, a missed credential can cost lives and licenses. HUMINEX ensures we never miss a renewal or certification.",
  ...
  "education": {
    ...
    testimonial: {
      quote: "HUMINEX understands education. From sabbaticals to study leaves to visiting faculty pay, everything just works.",
  ...
  "agriculture": {
    ...
    testimonial: {
      quote: "We manage 5,000 seasonal workers across 50 farms. HUMINEX offline mode and GPS attendance changed everything.",
  ...
  "logistics": {
    ...
    testimonial: {
      quote: "HUMINEX knows logistics. Driver fatigue alerts and hours tracking have made our fleet safer and more efficient.",
      author: "Vikram Singh",
  ...
  "hospitality": {
    ...
    testimonial: {
      quote: "Managing 15 properties with seasonal staff used to be a nightmare. HUMINEX gave us control we never imagined possible.",
      author: "Neha Rajput",
  ...
  "real-estate": {
    ...
    testimonial: {
      quote: "From construction sites to property management, HUMINEX handles our entire workforce ecosystem seamlessly.",
      author: "Arun Kapoor",
  ...
  "manufacturing": {
    ...
    testimonial: {
      quote: "Managing 3 plants with 10,000 workers in 3 shifts was chaos. HUMINEX brought structure and visibility.",
      author: "Rajesh Patel",
      role: "Plant HR Head",
  ...
  "technology": {
    ...
    testimonial: {
      quote: "HUMINEX understands tech companies. Project allocation, skill tracking, and remote work management just work.",
      author: "Amit Sharma",
  ...
  "finance": {
    ...
    testimonial: {
      quote: "In financial services, compliance isn't optional. HUMINEX keeps us audit-ready 365 days a year.",
      author: "Deepika Nair",
  ...
  "media": {
    ...
    testimonial: {
      quote: "Managing film productions with 500+ crew members is complex. HUMINEX handles guild compliance and call sheets effortlessly.",
  ...
  "professional": {
    ...
    testimonial: {
      quote: "HUMINEX understands professional services. Utilization tracking and partner comp calculations that actually work.",
      author: "Sanjay Gupta",
  ...
  "government": {
    ...
    testimonial: {
      quote: "HUMINEX handles the complexity of government HR like no other system we've seen.",
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative bg-card border border-border rounded-2xl p-8">
                <h3 className="text-xl font-heading font-bold text-foreground mb-6">How HUMINEX Solves These</h3>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground">
              These HUMINEX modules are specifically configured to address your industry's unique needs.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg mb-8">
              Join leading organizations that trust HUMINEX for their workforce operations.
            </p>
