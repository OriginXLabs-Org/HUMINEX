        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "200ms" }}>
              Every industry has unique challenges. HUMINEX is tailored to meet the specific workforce needs of your sector.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              We work across diverse sectors. Let's discuss how HUMINEX can be customized for your unique industry challenges.
            </p>
