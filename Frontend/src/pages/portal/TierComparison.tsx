...
const tierDetails: Record<ClientTier, {
  ...
  basic: {
    name: "Startup",
    description: "Essential tools for early teams",
    price: "₹199",
    ...
    highlights: ["5-50 employees", "Core employee workspace", "Email support"],
  },
  standard: {
    name: "Growth",
    ...
    highlights: ["50-300 employees", "Priority support", "Team collaboration", "Approval workflows"],
  },
  advanced: {
    name: "Enterprise",
    description: "Enterprise-grade operating controls",
    price: "₹499+",
    priceLabel: "/employee/month",
    icon: Crown,
    ...
    highlights: ["300+ employees", "AI-powered insights", "Advanced analytics", "Dedicated support", "Custom policy controls"],
  },
  enterprise: {
    name: "Enterprise Plus",
    description: "Complete solution for regulated enterprises",
    price: "Custom",
    priceLabel: "pricing",
    icon: Building2,
    ...
    highlights: ["Everything in Enterprise", "MSP Monitoring", "Custom integrations", "SLA guarantee", "24/7 phone support", "Dedicated account manager"],
  },
};
